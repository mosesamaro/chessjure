...
return cljs.core.map.call(null,(function (p1__14980_SHARP_){
return cljs.core.partial.call(null,p1__14980_SHARP_,my_side,app_state);
...
cljs.core.print.call(null,"In en-passant");

var current_row = chess_engine.board.get_row.call(null,pos);
var pawn_on_correct_rank = cljs.core._EQ_.call(null,parseInt(current_row),chess_engine.engine.passing_pawn_row_QMARK_.call(null,my_side));
if((!(pawn_on_correct_rank)) || (cljs.core._EQ_.call(null,new_pos,null))){
return false;
} else {
var vec__14982 = chess_engine.engine.get_position_functions.call(null,my_side,app_state);
var up = cljs.core.nth.call(null,vec__14982,(0),null);
var down = cljs.core.nth.call(null,vec__14982,(1),null);
var left = cljs.core.nth.call(null,vec__14982,(2),null);
var right = cljs.core.nth.call(null,vec__14982,(3),null);
...
var enemy_pawn = chess_engine.board.make_piece.call(null,enemy_side,"p");
var column_we_are_moving_to = chess_engine.board.get_col.call(null,left_or_right.call(null,pos));
var enemy_home_pos = chess_engine.board.make_pos.call(null,column_we_are_moving_to,enemy_starting_row);
var adjacent_pos = chess_engine.board.make_pos.call(null,column_we_are_moving_to,current_row);
...
var prev_board = new cljs.core.Keyword(null,"board","board",-1907017633).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null,cljs.core.rest.call(null,app_state)));
var prev_move_had_pawn_at_home = cljs.core._EQ_.call(null,chess_engine.board.get_piece_on_pos.call(null,enemy_home_pos,prev_board),enemy_pawn);
var home_pawn_is_now_gone = cljs.core._EQ_.call(null,chess_engine.board.get_piece_on_pos.call(null,enemy_home_pos,board),new cljs.core.Keyword(null,"ee","ee",643317400));
var prev_move_had_empty_adjacent = cljs.core._EQ_.call(null,chess_engine.board.get_piece_on_pos.call(null,adjacent_pos,prev_board),new cljs.core.Keyword(null,"ee","ee",643317400));
var adjacent_now_has_enemy_pawn = cljs.core._EQ_.call(null,chess_engine.board.get_piece_on_pos.call(null,adjacent_pos,board),enemy_pawn);
...
var vec__14984 = chess_engine.engine.get_position_functions.call(null,side,app_state);
var up = cljs.core.nth.call(null,vec__14984,(0),null);
var down = cljs.core.nth.call(null,vec__14984,(1),null);
var left = cljs.core.nth.call(null,vec__14984,(2),null);
var right = cljs.core.nth.call(null,vec__14984,(3),null);
...
var piece = new cljs.core.Keyword(null,"piece","piece",1396691784).cljs$core$IFn$_invoke$arity$1(unit);
var side = chess_engine.board.get_side.call(null,piece);
var vec__14986 = chess_engine.engine.get_position_functions.call(null,side,app_state);
var up = cljs.core.nth.call(null,vec__14986,(0),null);
var down = cljs.core.nth.call(null,vec__14986,(1),null);
var left = cljs.core.nth.call(null,vec__14986,(2),null);
var right = cljs.core.nth.call(null,vec__14986,(3),null);
...
var piece = new cljs.core.Keyword(null,"piece","piece",1396691784).cljs$core$IFn$_invoke$arity$1(unit);
var side = chess_engine.board.get_side.call(null,piece);
var vec__14988 = chess_engine.engine.get_position_functions.call(null,side,app_state);
var up = cljs.core.nth.call(null,vec__14988,(0),null);
var down = cljs.core.nth.call(null,vec__14988,(1),null);
var left = cljs.core.nth.call(null,vec__14988,(2),null);
var right = cljs.core.nth.call(null,vec__14988,(3),null);
var is_free_or_enemy2 = cljs.core.partial.call(null,chess_engine.engine.is_free_or_enemy2,app_state,side);
var first_knight_path_elm = ((function (pos,piece,side,vec__14988,up,down,left,right,is_free_or_enemy2){
...
});})(pos,piece,side,vec__14988,up,down,left,right,is_free_or_enemy2))
;
...
var piece = new cljs.core.Keyword(null,"piece","piece",1396691784).cljs$core$IFn$_invoke$arity$1(unit);
var side = chess_engine.board.get_side.call(null,piece);
var vec__14990 = chess_engine.engine.get_position_functions.call(null,side,app_state);
var up = cljs.core.nth.call(null,vec__14990,(0),null);
var down = cljs.core.nth.call(null,vec__14990,(1),null);
var left = cljs.core.nth.call(null,vec__14990,(2),null);
var right = cljs.core.nth.call(null,vec__14990,(3),null);
var is_free_or_enemy2 = cljs.core.partial.call(null,chess_engine.engine.is_free_or_enemy2,app_state,side);
...
var vec__14993 = chess_engine.engine.get_position_functions.call(null,side,app_state);
var up = cljs.core.nth.call(null,vec__14993,(0),null);
var down = cljs.core.nth.call(null,vec__14993,(1),null);
var left = cljs.core.nth.call(null,vec__14993,(2),null);
var right = cljs.core.nth.call(null,vec__14993,(3),null);
...
return ((function (pos,piece,side,starting_square,vec__14993,up,down,left,right,is_free_QMARK_,is_enemy_QMARK_,partial_is_en_passant_QMARK_){
return (function (p1__14991_SHARP_){
var or__8030__auto__ = is_enemy_QMARK_.call(null,p1__14991_SHARP_);
if(cljs.core.truth_(or__8030__auto__)){
return or__8030__auto__;
} else {
return partial_is_en_passant_QMARK_.call(null,p1__14991_SHARP_);
}
});
;})(pos,piece,side,starting_square,vec__14993,up,down,left,right,is_free_QMARK_,is_enemy_QMARK_,partial_is_en_passant_QMARK_))
})()
;
...
var vec__14995 = chess_engine.engine.get_position_functions.call(null,turn,app_state);
var up = cljs.core.nth.call(null,vec__14995,(0),null);
var down = cljs.core.nth.call(null,vec__14995,(1),null);
var left = cljs.core.nth.call(null,vec__14995,(2),null);
var right = cljs.core.nth.call(null,vec__14995,(3),null);
...
var board = new cljs.core.Keyword(null,"board","board",-1907017633).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null,app_state));
var turn = new cljs.core.Keyword(null,"turn","turn",75759344).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null,app_state));
var vec__14998 = chess_engine.engine.get_position_functions.call(null,turn,app_state);
var up = cljs.core.nth.call(null,vec__14998,(0),null);
var down = cljs.core.nth.call(null,vec__14998,(1),null);
var left = cljs.core.nth.call(null,vec__14998,(2),null);
var right = cljs.core.nth.call(null,vec__14998,(3),null);
var col = cljs.core.first.call(null,tokens);
var vec__14999 = tokens;
var start_col = cljs.core.nth.call(null,vec__14999,(0),null);
var _ = cljs.core.nth.call(null,vec__14999,(1),null);
var end_col = cljs.core.nth.call(null,vec__14999,(2),null);
var end_row = cljs.core.nth.call(null,vec__14999,(3),null);
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__15000_SHARP_){
return cljs.core._EQ_.call(null,"x",p1__15000_SHARP_);
}),tokens))){
...
var vec__15003 = cljs.core.map.call(null,(function (p1__15001_SHARP_){
return new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(p1__15001_SHARP_);
}),tokens);
var piece = cljs.core.nth.call(null,vec__15003,(0),null);
var start_pos = cljs.core.nth.call(null,vec__15003,(1),null);
var end_pos = cljs.core.nth.call(null,vec__15003,(2),null);
...
var vec__15006 = cljs.core.map.call(null,(function (p1__15004_SHARP_){
return new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(p1__15004_SHARP_);
}),chess_engine.engine.analyze_notation.call(null,notation));
var piece = cljs.core.nth.call(null,vec__15006,(0),null);
var start_pos = cljs.core.nth.call(null,vec__15006,(1),null);
var takes = cljs.core.nth.call(null,vec__15006,(2),null);
var end_pos = cljs.core.nth.call(null,vec__15006,(3),null);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start-pos","start-pos",668789086),start_pos,new cljs.core.Keyword(null,"piece","piece",1396691784),piece,new cljs.core.Keyword(null,"end-pos","end-pos",-1643883926),end_pos], null);
});
chess_engine.engine.find_piece_candidates = (function find_piece_candidates(notation,tokens,res,app_state){
var vec__15010 = cljs.core.map.call(null,(function (p1__15007_SHARP_){
return new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(p1__15007_SHARP_);
}),tokens);
var piece_type = cljs.core.nth.call(null,vec__15010,(0),null);
var end_pos = cljs.core.nth.call(null,vec__15010,(1),null);
...
var matching_start_pos = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.filter.call(null,((function (vec__15010,piece_type,end_pos,foo,piece,maybe_start_pos){
return (function (p1__15008_SHARP_){
return cljs.core._EQ_.call(null,chess_engine.board.get_piece_on_pos.call(null,p1__15008_SHARP_,new cljs.core.Keyword(null,"board","board",-1907017633).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null,app_state))),piece);
});})(vec__15010,piece_type,end_pos,foo,piece,maybe_start_pos))
,maybe_start_pos));
...
var vec__15015 = cljs.core.map.call(null,((function (get_col_or_row){
return (function (p1__15011_SHARP_){
return new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(p1__15011_SHARP_);
});})(get_col_or_row))
,tokens);
var piece_type = cljs.core.nth.call(null,vec__15015,(0),null);
var start_col_or_row = cljs.core.nth.call(null,vec__15015,(1),null);
var end_pos = cljs.core.nth.call(null,vec__15015,(2),null);
var candidate_positions = chess_engine.engine.find_piece_candidates.call(null,notation,cljs.core.filter.call(null,((function (get_col_or_row,vec__15015,piece_type,start_col_or_row,end_pos){
return (function (p1__15012_SHARP_){
return !(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__15012_SHARP_),col_or_row_keyword));
});})(get_col_or_row,vec__15015,piece_type,start_col_or_row,end_pos))
,tokens),res,app_state);
var candidate_positions_on_col_or_row = cljs.core.filter.call(null,((function (get_col_or_row,vec__15015,piece_type,start_col_or_row,end_pos,candidate_positions){
return (function (p1__15013_SHARP_){
return cljs.core._EQ_.call(null,get_col_or_row.call(null,p1__15013_SHARP_),start_col_or_row);
});})(get_col_or_row,vec__15015,piece_type,start_col_or_row,end_pos,candidate_positions))
,candidate_positions);
...
var vec__15018 = cljs.core.map.call(null,(function (p1__15016_SHARP_){
return new cljs.core.Keyword(null,"token","token",-1211463215).cljs$core$IFn$_invoke$arity$1(p1__15016_SHARP_);
}),tokens);
var piece_type = cljs.core.nth.call(null,vec__15018,(0),null);
var end_pos = cljs.core.nth.call(null,vec__15018,(1),null);
...
return chess_engine.engine.piece_pos.call(null,cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.filter.call(null,(function (p1__15019_SHARP_){
return !(cljs.core._EQ_.call(null,"x",p1__15019_SHARP_));
}),notation)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.filter.call(null,(function (p1__15020_SHARP_){
return !(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__15020_SHARP_),new cljs.core.Keyword(null,"takes","takes",-1342283563)));
}),tokens)),res,app_state);
});
...
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__15021_SHARP_);
});})(tokens))
,tokens);
...
cljs.core.print.call(null,"In Move ",a_move,"should have printed move");
...
var turn = new cljs.core.Keyword(null,"turn","turn",75759344).cljs$core$IFn$_invoke$arity$1(cljs.core.peek.call(null,app_state));
var has_white_king_moved = (((cljs.core._EQ_.call(null,turn,"w")) && (chess_engine.engine.has_king_moved.call(null,app_state,a_move)))?true:false);
var has_black_king_moved = (((cljs.core._EQ_.call(null,turn,"b")) && (chess_engine.engine.has_king_moved.call(null,app_state,a_move)))?true:false);
