...
sablono.util.ToString = (function (){var obj16275 = {};
return obj16275;
})();
...
return (function (){var or__8030__auto__ = (sablono.util.to_str[goog.typeOf(x__8674__auto__)]);
if(or__8030__auto__){
return or__8030__auto__;
} else {
var or__8030__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj16277 = {};
return obj16277;
})();
...
var x__8674__auto__ = (((x == null))?null:x);
return (function (){var or__8030__auto__ = (sablono.util.to_uri[goog.typeOf(x__8674__auto__)]);
if(or__8030__auto__){
return or__8030__auto__;
} else {
var or__8030__auto____$1 = (sablono.util.to_uri["_"]);
if(or__8030__auto____$1){
return or__8030__auto____$1;
} else {
...
as_str.cljs$lang$applyTo = (function (arglist__16278){
var xs = cljs.core.seq(arglist__16278);
...
var vec__16280 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__16280,(0),null);
var words = cljs.core.nthnext.call(null,vec__16280,(1));
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__16285_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__16285_SHARP_)){
...
var vec__16290 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__16290,(0),null);
var names = cljs.core.nth.call(null,vec__16290,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__16290,tag_name,names){
return (function (p1__16287_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__16287_SHARP_));
...
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__16288_SHARP_));
});})(matches,vec__16290,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__16291){
var vec__16294 = p__16291;
var tag = cljs.core.nth.call(null,vec__16294,(0),null);
var content = cljs.core.nthnext.call(null,vec__16294,(1));
...
var vec__16295 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__16295,(0),null);
var id = cljs.core.nth.call(null,vec__16295,(1),null);
var class$ = cljs.core.nth.call(null,vec__16295,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__8030__auto__ = x__$1.hasDomain();
